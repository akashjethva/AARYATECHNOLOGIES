...
export default function ReportsPage() {
    ...
    const getReportContent = (title: string) => {
        if (title.includes('Staff') || title.includes('Handover') || title.includes('Performance')) {
            return `
                <div class="section">
                    <div class="section-title">Staff Metrics</div>
                    <table>
                        <thead>
                            <tr>
                                <th>Staff Name</th>
                                ...
                                <th style="text-align: right;">Pending Handover</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>Rahul Varma</td>
                                <td><span style="background: #dcfce7; color: #166534; padding: 2px 6px; border-radius: 4px; font-size: 10px; font-weight: bold;">ACTIVE</span></td>
                                <td style="text-align: right;">98%</td>
                                <td style="text-align: right; font-weight: bold;">₹ 15,200</td>
                            </tr>
                            <tr>
                                <td>Amit Kumar</td>
                                <td><span style="background: #e0f2fe; color: #075985; padding: 2px 6px; border-radius: 4px; font-size: 10px; font-weight: bold;">ON ROUTE</span></td>
                                <td style="text-align: right;">92%</td>
                                <td style="text-align: right; font-weight: bold;">₹ 8,450</td>
                            </tr>
                            <tr>
                                <td>Vikram Singh</td>
                                <td><span style="background: #fee2e2; color: #991b1b; padding: 2px 6px; border-radius: 4px; font-size: 10px; font-weight: bold;">OFF DUTY</span></td>
                                <td style="text-align: right;">85%</td>
                                <td style="text-align: right; font-weight: bold;">₹ 2,100</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="section">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Payout</td>
                                <td>Suresh Enterprise</td>
                                <td>Jan 03, 2026</td>
                                <td style="text-align: right; font-weight: bold;">₹ 23,800</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            `;
        } else if (title.includes('Tax') || title.includes('GST')) {
            return `
                <div class="section">
                    <div class="section-title">Tax Summary (Jan 2026)</div>
                    <div class="stats-grid">
                        <div class="stat-item">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: bold;">₹ 90,000</td>
                            </tr>
                            <tr>
                                <td>CGST</td>
                                <td>9%</td>
                                <td style="text-align: right;">₹ 1,72,500</td>
                                <td style="text-align: right; font-weight: bold;">₹ 31,050</td>
                            </tr>
                            <tr>
                                <td>SGST</td>
                                <td>9%</td>
                            ...
                            <tr style="background: #f8fafc; font-weight: bold;">
                                <td colspan="3" style="text-align: right;">Total GST Liability</td>
                                <td style="text-align: right;">₹ 1,52,100</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    const handleExport = (reportTitle: string = "Financial Report") => {
        setIsExporting(true);
            ...
            const htmlContent = `
                ...
                <body>
                    <div class="header">
                        ...
                        <div class="invoice-title">${reportTitle.toUpperCase()}<br><span style="font-size: 14px; font-weight: normal;">${selectedDate}</span></div>
                    </div>

                    ${getReportContent(reportTitle)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-[#1e293b]/60 backdrop-blur-sm rounded-[2.5rem] p-8 border border-white/5 shadow-xl">
                            ...
                            <div className="space-y-4">
                                <ReportItem title="Daily Collection Summary" subtitle="Selected: Today" onClick={() => handleExport("Daily Collection Summary")} />
                                <ReportItem title="Monthly Tax / GST Report" subtitle="FY 2025-26" onClick={() => handleExport("Monthly Tax / GST Report")} />
                                <ReportItem title="Expense & Payout Dictionary" subtitle="All Verified Entries" onClick={() => handleExport("Expense & Payout Dictionary")} />
                            </div>
                        </div>
                        ...
                        <div className="bg-[#1e293b]/60 backdrop-blur-sm rounded-[2.5rem] p-8 border border-white/5 shadow-xl">
                            ...
                            <div className="space-y-4">
                                <ReportItem title="Staff Efficiency Scorecard" subtitle="Monthly Performance" onClick={() => handleExport("Staff Efficiency Scorecard")} />
                                <ReportItem title="Pending Handovers List" subtitle="Live Status" onClick={() => handleExport("Pending Handovers List")} />
                                <ReportItem title="Route Coverage Analysis" subtitle="Zone-wise Report" onClick={() => handleExport("Route Coverage Analysis")} />
                            </div>
                        </div>
                    </div>
