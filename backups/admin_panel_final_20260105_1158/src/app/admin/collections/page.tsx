                                            ...
                                            <AnimatePresence>
                                                {activeActionId === t.id && (
                                                    <motion.div
                                                        ...
                                                        className="absolute right-10 top-8 z-50 w-40 bg-[#1e293b] border border-white/10 rounded-xl shadow-xl overflow-hidden"
                                                        onClick={(e) => e.stopPropagation()}
                                                    >
                                                        <div className="flex flex-col p-1">
                                                            <button
                                                                onClick={() => { setSelectedTransaction(t); setActiveActionId(null); }}
                                                                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors text-left"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors text-left"
                                                            >
                                                                <Edit size={14} className="text-amber-400" /> Edit Entry
                                                            </button>
                                                            <div className="h-px bg-white/5 my-1"></div>
                                                            <button
                                                                onClick={() => handleDelete(t.id)}
                                                                className="flex items-center gap-2 px-3 py-2 text-sm font-bold text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors text-left"
                                                            >
