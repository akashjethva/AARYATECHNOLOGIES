...
export default function StaffCustomers() {
    ...
    const customers = [
        ...
        { id: 3, name: "Ganesh Provision", contact: "Suresh Patel", phone: "+91 98980 12345", city: "Rajkot", balance: "12,500", lastVisit: "Today", history: [] },
        { id: 4, name: "Om Enterprise", contact: "Amit Shah", phone: "+91 99887 55443", city: "Vadodara", balance: "0", lastVisit: "Last Week", history: [] },
        { id: 5, name: "Maruti Nandan", contact: "Vikram Solanki", phone: "+91 97654 32109", city: "Surat", balance: "2,100", lastVisit: "3 days ago", history: [] },
    ];
                ...
                {filtered.map((customer, idx) => (
                    ...
                    >
                        ...
                        <div className="flex gap-2">
                            ...
                            <button className="flex-1 py-3 rounded-xl bg-[#16181d] text-slate-400 font-bold text-xs flex items-center justify-center gap-2 hover:bg-white/5 transition-colors border border-white/5">
                ...
                <div className="flex-1 overflow-y-auto px-8 py-8 space-y-8 scrollbar-hide pb-24">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <button className="flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
