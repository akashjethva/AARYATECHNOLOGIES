        ...
        <div className="flex h-screen bg-[#0f172a] text-white font-sans overflow-hidden p-0 md:p-4 gap-4 selection:bg-indigo-500 selection:text-white relative">
            ...
            <motion.aside
                ...
                animate={{
                    ...
                    width: isMobile ? 280 : (isSidebarOpen ? 280 : 96),
                    opacity: 1
                }}
                transition={{
                    type: "tween",
                ...
                className={`
                    ...
                    bg-[#1e293b]/95 backdrop-blur-xl border-r md:border border-white/10 
                    md:rounded-[2.5rem] flex flex-col shadow-2xl overflow-hidden
                    ${isMobile ? 'rounded-r-[2.5rem] w-[280px]' : ''}
                `}
            >
                {/* Decorative Gradients - Reduced opacity for performance */}
                <div className="absolute -top-24 -left-24 w-48 h-48 bg-blue-500/10 rounded-full blur-[80px]"></div>
                <div className="absolute bottom-0 right-0 w-48 h-48 bg-purple-500/10 rounded-full blur-[80px]"></div>
            ...
            <main className="flex-1 bg-[#0f172a] md:rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col relative border border-white/5 z-0">
                ...
                {/* Main Content Scroll Area - Div with pb-32 for mobile bottom nav */}
                <div className={`flex-1 relative z-0 overflow-y-auto h-full scrollbar-hide md:rounded-[2.5rem] bg-[#1e293b]/50 border border-white/5 transition-all duration-300 pb-32 md:pb-0`}>
                    {children}
                </div>
